...
- PriceFeed contract: [PriceFeed.h](file:///workspace/src/contracts/PriceFeed.h)
- Perpetuals contract: [Perpetuals.h](file:///workspace/src/contracts/Perpetuals.h)
...
- Contract registration wiring: [contract_def.h](file:///workspace/src/contract_core/contract_def.h#L424-L447)
...
- **Source:** [PriceFeed.h](file:///workspace/src/contracts/PriceFeed.h)

### 2) Perpetuals (PERPS)
- **Contract index:** 21
- **Asset name:** PERPS
- **State type:** `PERPETUALS`
- **Source:** [Perpetuals.h](file:///workspace/src/contracts/Perpetuals.h)
...
- The current PERPS implementation sets a mock entry price rather than calling PFEED for pricing ([Perpetuals.h](file:///workspace/src/contracts/Perpetuals.h#L457-L475)).
...
- Test summary: [TESTING_SUMMARY.md](file:///workspace/docs/TESTING_SUMMARY.md)
- PriceFeed tests: [contract_pricefeed.cpp](file:///workspace/test/contract_pricefeed.cpp)
- Perpetuals tests: [contract_perpetuals.cpp](file:///workspace/test/contract_perpetuals.cpp)
